...
public class EpubInfo {
	...
	public static final String hrefAttrName = "href";
	public static final String typeAttrName = "media-type";
	
	public static final String rootFileTagName = "rootfile";
	public static final String fullPathAttrName = "full-path";
